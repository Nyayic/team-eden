        ...
        <div class="row">
          <div class="col-md-5 mr-auto align-self-center text-center text-md-left">
            <div class="intro-text">
              ...
              <p class="mb-4">
              The <b class="text-success">Sumatran Rhino Sanctuary (SRS)</b> in Indonesia is home to seven rhinos that are part of an 
              intensively-managed research and breeding program aimed at increasing Sumatra’s wild rhino population.
              Answer these 8 fun questions about your personality and interests to discover the one Sumatran 
              Rhino that you relate to most.
              </p>
              
               <!---->
                <!-- Small modal -->
                <button type="button" class="btn btn-outline-success" data-toggle="modal" data-target=".bd-example-modal-sm" value="Play Game">
                ...
                <div class="modal fade bd-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
                  <div class="modal-dialog modal-sm">
                    <div class="modal-content">
                        <div class="modal-header">
                          ...
                          <form action="<!?php htmlspecialchars($_SERVER["PHP_SELF"]) ?>" method="POST" id="start-form">
                              ...
                              <div class="form-group">
                                ...
                                <div class="form-group">
                                  <input type="submit" class="btn btn btn-outline-success" name="submit_button" value="Continue">
                                </div>
                                <div class="form-group">
                  ...
                  <!--input type="submit" class="btn btn-outline-success offset-3 play-btn" value="Play game"-->
            </div>
          </div>
          <div class="col-md-7 align-self-center text-center text-md-right">
            <img src="images/Ratu-2018.jpg" alt="Image" class="img-fluid cover-img">
            <img src="images/Rosa-2018.jpg" alt="Image" class="img-fluid cover-img2">
          </div>
        </div>
      </div>
    </section> 
            ...
            <div class="row">
              <div class="col-md-3">
                ...
                <ul class="list-unstyled">
                  <li><a href="#about-section" class="smoothscroll">MISSION</a></li>
                  <li><a href="#trainers-section" class="smoothscroll">TEAM</a></li>
                  <li><a href="#services-section" class="smoothscroll">POLICIES</a></li>
                </ul>
                 
              </div>
              <div class="col-md-3 ml-auto">
                <h2 class="footer-heading mb-4">PARTNERS</h2>
                <ul class="list-unstyled">
                  <li><a href="#testimonials-section" class="smoothscroll">CORPORATE PARTNERS</a></li>
                  <li><a href="#contact-section" class="smoothscroll">ZOO PARTNERS</a></li>
                  <li><a href="#contact-section" class="smoothscroll">GRANTEES</a></li>
                </ul>
              </div>
              <div class="col-md-2">
                <h2 class="footer-heading mb-4">FOLLOW US</h2>
                <a href="#" class="pl-0 pr-3 social-link"><span class="icon-facebook">Facebook</span></a>
                <a href="#" class="pl-3 pr-3 social-link"><span class="icon-twitter">Twitter</span></a>
                <a href="#" class="pl-3 pr-3 social-link"><span class="icon-instagram">Instagram</span></a>
                <a href="#" class="pl-3 pr-3 social-link"><span class="icon-linkedin">LinkedIn</span></a>
              </div>
            </div>
          </div>
          <div class="col-md-4">
            <h2 class="footer-heading mb-4">GET INVOLVED</h2>
            <ul class="list-unstyled">
                  <li><a href="#" class="btn btn-success smoothscroll">DONATE</a></li>
                  <li><a href="#" class="btn btn-primary smoothscroll">ADAPT</a></li>
                  <li><a href="#" class="btn btn-info smoothscroll">SHOP</a></li>
                </ul>
